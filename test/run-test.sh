...
function run_code_tests {
    ...
    #run_test "check changelog example unchanged" "md5sum -c - <<< 'a52e1076c63700f4e24a2bdc0e1973e5 *html/changelogs/example.yml'" - Because nobody bothered to keep changelog up to date.
...
function run_byond_tests {
    ...
    run_test "check globals unchanged" "md5sum -c - <<< 'a52e1076c63700f4e24a2bdc0e1973e5 *code/_helpers/global_access.dm'"
