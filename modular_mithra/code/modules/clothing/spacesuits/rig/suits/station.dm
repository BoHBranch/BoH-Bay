...
/obj/item/clothing/head/helmet/space/rig/industrial
	species_restricted = list(SPECIES_HUMAN,SPECIES_PLASMASANS,SPECIES_SKRELL,SPECIES_UNATHI,SPECIES_OLDUNATHI,SPECIES_AKULA,SPECIES_VULP,SPECIES_VASS,SPECIES_TAJ,SPECIES_HUMAN2,SPECIES_SERGAL,SPECIES_NORTHERN,SPECIES_EASTERN,SPECIES_IPC)
