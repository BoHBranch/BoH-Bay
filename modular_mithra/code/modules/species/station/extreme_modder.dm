/datum/species/custom/aberration
	name = SPECIES_ECUSTOM
	name_plural = SPECIES_ECUSTOM
	...
	Aberrations are considered an extreme form of Genemodding and have more restrictions, but also more customization."
