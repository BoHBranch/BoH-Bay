...
#define CALIBER_PISTOL_SMALL 	".22LR"
#define CALIBER_PISTOL_MAGNUM 	".44"
#define CALIBER_PISTOL_FLECHETTE "4mm"
#define CALIBER_PISTOL_ANTIQUE	".45"
#define CALIBER_PISTOL_MAGNUM_LARGE ".454"

#define CALIBER_RIFLE			".300BL"
#define CALIBER_RIFLE_MILITARY  "6.5mm"
#define CALIBER_RIFLE_MILITARY_LARGE ".338L"
#define CALIBER_ANTIMATERIAL    "12.7mm"
