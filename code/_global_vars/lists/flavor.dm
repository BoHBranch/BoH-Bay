...
GLOBAL_LIST_INIT(music_tracks, list(
	...
	"Cum zone" = /music_track/cumzone,
	"Curb your enthusiasm" = /music_track/curb,
	"Space channel 5" = /music_track/spacechannel,
	"Dust" = /music_track/dust,
	"Space cowboy" = /music_track/spesscowboy,
	"Virtual insanity" = /music_track/virtualinsanity,
	"Triage at dawn" = /music_track/hlife,
	"Sitting duck" = /music_track/acecombat,
	"Dragons" = /music_track/dragons,
	"Every day is night" = /music_track/everydayisnight,
	"Hollow faces" = /music_track/hollowfaces,
	"Second trumpet" = /music_track/secondtrumpet,
	"Sneakman" = /music_track/sneakman,
	"Gun godz" = /music_track/gungodz,
	"Dizzy" = /music_track/dizzy,
