...
//Mirtha garbage. If something is added by an upstream, move all these numbers up by 1.
...
#define DNA_UI_LENGTH      35 // Update this when you add something, or you WILL break shit. Should match the final value in the previous list.
...
/datum/dna
	...
	//Genemodders. Adds new variables to /datum/dna.
	var/custom_species
...
/datum/dna/proc/Clone()
	...
	//Genemodder code so their scrungly genetics are recorded
...
/datum/dna/proc/ResetUIFrom(mob/living/carbon/human/character)
	...
	// MITHRA Technically custom_species is not part of the UI, but this place avoids merge problems.
	...
	//Adds genetic traces to all the genemodder parts. Without this, cloning genemodders would make them lose their traits. (Not a huge loss)
