/obj/machinery/suit_cycler/engineering
	...
	species = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI,SPECIES_SERGAL,SPECIES_NORTHERN,SPECIES_EASTERN) //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI,SPECIES_SERGAL,SPECIES_NORTHERN,SPECIES_EASTERN)
