/obj/item/weapon/gun/magnetic/railgun
	name = "HTA LM-76 \"Thunderclap\""
	desc = "The HelTek Arms LM-76 LM-76 \"Thunderclap\". A portable linear motor cannon produced during the Aigaion Conflict for anti-armour and anti-fortification operations. Today, it sees wide use among private militaries, and is a staple on the black market."
...
/obj/item/weapon/gun/magnetic/railgun/automatic // Adminspawn only, this shit is absurd.
	name = "\improper LMRA \"Meteor\" autocannon"
