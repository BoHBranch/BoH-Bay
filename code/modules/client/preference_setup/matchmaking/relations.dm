...
/datum/category_item/player_setup_item/relations/load_character(var/savefile/S)
	from_save_key(S, "relations", pref.relations)
	from_save_key(S, "relations_info", pref.relations_info)

/datum/category_item/player_setup_item/relations/save_character(var/savefile/S)
	to_save_key(S, "relations", pref.relations)
	to_save_key(S, "relations_info", pref.relations_info)
