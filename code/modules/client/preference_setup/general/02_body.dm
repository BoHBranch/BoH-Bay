...
/datum/preferences
	...
	var/r_hair = 172						//Hair color
	var/g_hair = 86						//Hair color
	var/b_hair = 0						//Hair color
	var/f_style = "Dwarf Beard"			//Face hair type
	var/r_facial = 172					//Face hair color
	var/g_facial = 86					//Face hair color
