...
/datum/category_item/player_setup_item/player_global/ui/load_preferences(var/savefile/S)
	from_save_key(S, "UI_style", pref.UI_style)
	from_save_key(S, "UI_style_color", pref.UI_style_color)
	from_save_key(S, "UI_style_alpha", pref.UI_style_alpha)
	from_save_key(S, "ooccolor", pref.ooccolor)
	from_save_key(S, "clientfps", pref.clientfps)

/datum/category_item/player_setup_item/player_global/ui/save_preferences(var/savefile/S)
	to_save_key(S, "UI_style", pref.UI_style)
	to_save_key(S, "UI_style_color", pref.UI_style_color)
	to_save_key(S, "UI_style_alpha", pref.UI_style_alpha)
	to_save_key(S, "ooccolor", pref.ooccolor)
	to_save_key(S, "clientfps", pref.clientfps)
