...
/datum/recipe/cookie
	appliance = OVEN
	reagents = list(/datum/reagent/sugar = 10, /datum/reagent/nutriment/batter/cakebatter = 20, /datum/reagent/nutriment/coco = 10)
...
/datum/recipe/plumphelmetbiscuitvegan
	appliance = OVEN
	fruit = list("plumphelmet" = 1)
	reagents = list(/datum/reagent/water = 10, /datum/reagent/nutriment/flour = 10)
	result = /obj/item/reagent_containers/food/snacks/plumphelmetbiscuit

/datum/recipe/unscotti
	appliance = OVEN
	reagents = list(
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/unscottiloaf

/datum/recipe/biscotti
	appliance = OVEN
	items = list(
		/obj/item/reagent_containers/food/snacks/slice/unscotti
	)
	result = /obj/item/reagent_containers/food/snacks/biscotti
...
/datum/recipe/cake/lemoncake
	fruit = list("lemon" = 3)
	reagents = list(/datum/reagent/nutriment/batter/cakebatter = 30, /datum/reagent/drink/juice/lemon = 3)
...
/datum/recipe/cake/chocolatecake
	...
	reagents = list(/datum/reagent/nutriment/batter/cakebatter = 30, /datum/reagent/nutriment/coco = 4)
...
/datum/recipe/oysters_rockefeller
	...
	result = /obj/item/reagent_containers/food/snacks/oysters_rockefeller
	reagent_mix = RECIPE_REAGENT_REPLACE
