...
/obj/item/tray/proc/load_item(var/obj/item/I, var/mob/user, var/click_params)
	...
	if(istype(loc, /mob/))
		I.hud_layerise()
	GLOB.item_equipped_event.register(I, src, /obj/item/tray/proc/pick_up)
	GLOB.destroyed_event.register(I, src, /obj/item/tray/proc/unload_item)
...
/obj/item/tray/proc/auto_align(obj/item/W, click_params)
