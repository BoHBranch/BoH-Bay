...
/obj/item/reagent_containers/food/snacks/variable/on_update_icon()
...
/obj/item/reagent_containers/food/snacks/variable/pancakes
	name = "pancakes"
	desc = "Pancakes with a special twist, hopefully delicious."
	icon_state = "pancakescustom"
	size = 8

/obj/item/reagent_containers/food/snacks/variable/burger
	name = "burger"
	desc = "Mankind will come together, reunited between these fluffy buns!"
	icon_state = "customburger"
	size = 8

/obj/item/reagent_containers/food/snacks/variable/stew
	name = "stew"
	desc = "A delicious use of stale produce."
	icon_state = "stew"
	size = 15
