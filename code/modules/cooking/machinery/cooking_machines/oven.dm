/obj/machinery/appliance/cooker/oven
	...
	stat = POWER_USE_ACTIVE	//Starts turned off
...
/obj/machinery/appliance/cooker/oven/proc/manip(obj/item/I, mob/user)
...
/obj/machinery/appliance/cooker/oven/can_insert(obj/item/I, mob/user)
	if (!open && !manip(I, user))
		to_chat(user, "<span class='warning'>You can't put anything in while the door is closed!")
		return 0
...
/obj/machinery/appliance/cooker/oven/can_remove_items(mob/user)
	if (!open)
		to_chat(user, "<span class='warning'>You can't take anything out while the door is closed!")
		return FALSE
