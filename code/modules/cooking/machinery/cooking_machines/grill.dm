...
/obj/machinery/appliance/grill/attempt_toggle_power(mob/user)
	. = ..()
	if(use_power)
...
/obj/machinery/appliance/grill/has_space(obj/item/I)
...
/obj/machinery/appliance/grill/removal_menu(mob/user)
