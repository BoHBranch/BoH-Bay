...
/obj/machinery/icecream_vat
	...
	reagents_to_add = list(/datum/reagent/drink/milk = 5, /datum/reagent/nutriment/flour = 5, /datum/reagent/sugar = 5, /datum/reagent/drink/ice = 5)
	...
	if(istype(O, /obj/item/weapon/reagent_containers/food/snacks/icecream))
		...
		if(!I.ice_creamed)
			if(product_types[dispense_flavour] > 0)
				src.visible_message("[icon2html(src, viewers(src))]src] <span class='info'>[user] scoops delicious [flavour_name] icecream into [I].</span>")
