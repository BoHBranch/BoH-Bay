...
//		log_debug("Adding [lowertext(seperate[next])] to [lowertext(seperate[Xa])]")
	...
	if(prob(30))
		...
		holder_atom.loc.visible_message("<span class='notice'>[icon2html(src, viewers(src))]holder_atom] [pick(options)]</span>")
...
/datum/talking_atom/proc/SaySomething(var/word = null)
	...
	for(var/mob/M in listening)
		to_chat(M, "[icon2html(src, viewers(src))]holder_atom] <b>[holder_atom]</b> reverberates, <span class='notice'>\"[msg]\"</span>")
