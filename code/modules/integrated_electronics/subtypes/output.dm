...
/obj/item/integrated_circuit/output/screen/medium/do_work()
	...
	for(var/mob/M in nearby_things)
		...
		to_chat(M, "<span class='notice'>[icon2html(src, viewers(src))]O] [stuff_to_display]</span>")
...
/obj/item/integrated_circuit/output/screen/large/do_work()
	...
	O.visible_message("<span class='notice'>[icon2html(src, viewers(src))]O]  [stuff_to_display]</span>")
