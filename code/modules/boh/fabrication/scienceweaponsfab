/obj/machinery/science_weapons_fabricator
	name = "Science Weapons Fabricator"
	desc = "A modified fabricator designed by science personnel to produce weapons instead of common items."
...
/obj/item/weapon/stock_parts/circuitboard/scienceweaponsfab
	name = "Circuit board (Science Weapons Fabricator)"
	build_path = /obj/machinery/science_weapons_fabricator
	board_type = "machine"
