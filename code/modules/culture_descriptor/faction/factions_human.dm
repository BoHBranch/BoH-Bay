/decl/cultural_info/faction/scg
	...
	Based in the Sol System and with most seats of Government found on Earth.\
	the SCG governs the majority of human space. Currently engaged in a Orion-Arm spanning war against multiple hostile factions, \
	Its primary governing bodies are the Council of Planets,  \
	...
	including many non-humans (though they are not entitled to become citizens) and encompassing a wide range of systems, territories \
	habitats, and celestial bodies. However, it is large, cumbersome, divided and slow to respond to issues due to \
	its massive bureaucracy and the distance between worlds. It recently gained it's independence from the control of \
	the Corporations during the Corporate-Wars. Through its member states, the SCG governs as one of the \
	most advanced and powerful civilisations in the known galaxy."

/decl/cultural_info/faction/scg/fleet
	name = FACTION_FLEET
	description = "The Fleet is the primary component of the SCG Defence Forces. It has been the hammer of SolGov in the many wars of the 34th Millenium. \
	With its last serious military engagement being the Human-Ascent war over 6 years ago. \
...
/decl/cultural_info/faction/gcc
	...
	description = "The United Colonies of Gilgamesh was once a major power within human space that, \
	after the Gaian Conflict: Became a member state of the Solarian Government. It's people were once a proudly humanist-faction \
	that dispersed any notion of 'intergrating' xenonic peoples into their culture. Controlling nearly fourty-two percent of Phoron supplies \
	on it's colonies, the Gilgamesh Government was accused of the manufacturing of phoron-salted nuclear weapons and thusly invaded by the Solarian Government \
	after a fourty year cold-war. The battle of Gaia was considered one of the worst in human history, lasting over twenty months and costing over half a million lives; \
	mostly that of Civilians caught in the crossfire between both factions. It's mass use of advanced Vatborn technology has made the post-gilgamesh people respected as some of the best \
	bioengineers in human-space. Through many veterans of the wars hold grudges that still burn hot in their hearts."
	economic_power = 0.7
...
/decl/cultural_info/faction/remote/nanotrasen
	...
	Currently headquartered in New Amsterdam on Luna. Nanotrasen was forcefully intergrated into a Government controlled entity after the Corporate-Wars. \
	It's technology is widely considered some of the most advanced that humanity has ever produced, deeply involving itself during 'The Colonial Century' as the premier \
	producers and researchers of Plasma, offically named 'Phoron'. Some believe that Nanotrasen once controlled most of the politics within Human-Space until the War, with some \
	claiming that even now Nanotrasen attempts to reclaim it's lost monopoly on the entirety of humanity."
	economic_power = 1.2
...
/decl/cultural_info/faction/remote/xynergy
	...
	produce products such as the Giant Armoured Serpentides. In addition, they are the largest \
	fisher of space faring animals such as space carp and pike. They were a major player in the Corporate Wars, using such vast swathes of GAS that \
	an entirely new branch of the Solarian military was created to combat it: The Territorials."
	economic_power = 1.1
	subversive_potential = 15
...
/decl/cultural_info/faction/remote/hephaestus
	...
	They did not participate in the Corporate Wars and instead sided with the Government as a military-contractor. Some believe this was to ensure \
	their freedom and survival after the war. As they are indeed one of the few megacorporations not owned by SolGov."
	economic_power = 1.2
	subversive_potential = 15

/decl/cultural_info/faction/free
	name = FACTION_FREETRADE
	description = "The Free Trade Union, commonly referred to as the FTU, was a employee owned corporation that belived wholly in Libertarianism. \
	offically a weapons producer under the licence of 'United Arms Factories, they also produced simply rampant amount of narcotics, including Black-Spice! \
	They were taken over during the Corporate Wars after their company headquarters and stocks were put up for auction in a bid to 'cash-out' of the coming crisis. \
	Making most of it's employees due to 'buyout' incredibly rich!"
	economic_power = 1.3
	subversive_potential = 15
...
/decl/cultural_info/faction/dais
	...
	Currently DAIS is invested in bluespace computing research and artificial intelligence research. They are one of the few corporate entities that were Government owned previous to the War."
	economic_power = 1.1
	subversive_potential = 15
