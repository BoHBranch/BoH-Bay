...
/decl/cultural_info/culture/nabber/b
	...
	valid_jobs = list(/datum/job/janitor, /datum/job/bartender, /datum/job/chef)
...
/decl/cultural_info/culture/nabber/a
	...
	valid_jobs = list(/datum/job/janitor, /datum/job/bartender, /datum/job/chef, /datum/job/chemist, /datum/job/roboticist)
