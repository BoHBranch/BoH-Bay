/decl/cultural_info/culture/unathi
	...
	over their lowland vassals, protecting them and Moghes in the name of the Grand Strategem - although the clear \
	division between feudal masters and their subject clans was gradually wearing away, the split has been resolved \
	with some vassal clans being the first to submit to the SCG, gaining freedom from their former lords. \
	In reaction, other lords submit to the SCG immediately in exchange for the SCG indirectly helping them control their vassals. \
	In spite of this, those lords act more suspicious of humanity than most, and many suspect they intentionally offered more troops\
	to the SCG so that they can keep a close eye on things."
	economic_power = 0.8
...
/decl/cultural_info/culture/unathi_polar
	...
	common to find off-world. Many of these unathi are followers of the Precursors or the Fruitful Lights, with technology and progress being \
	an important concept in the polar city-states. Because of all this, the poles are the biggest melting pot with the most commerce, full of \
	guilds and, in some cases, pollution. Air quality is important for unathi, and some have weakeneed or null regeneration thanks to the smog."
	economic_power = 0.9
	language = LANGUAGE_UNATHI_SINTA
	secondary_langs = list(
		LANGUAGE_UNATHI_YEOSA,
...
/decl/cultural_info/culture/unathi_desert
	...
	the Precursors and the Grand Stratagem in their clan faiths, and are often considered the most spiritual. Some view them as the most violent of savages, \
	being known for their fighting-pits more than anything, but currently most their fights are against outsiders trying to dig up precursor technology."
	language = LANGUAGE_UNATHI_SINTA
	secondary_langs = list(
		LANGUAGE_UNATHI_YEOSA,
		LANGUAGE_SIGN,
...
/decl/cultural_info/culture/unathi_savannah
	...
	Excellent farmers, riders and herdsmen, most savannah unathi follow the Hand of the Vines. They often trade with the poles and occasionally fight off raiders \
	from the desert, but usually no one is severely hurt in these skirmishes. The Savannah lifestyle is very healthy for Sinta, and many of the farmers are among \
	the largest of unathi."
	language = LANGUAGE_UNATHI_SINTA
	secondary_langs = list(
		LANGUAGE_UNATHI_YEOSA,
		LANGUAGE_SIGN,
...
/decl/cultural_info/culture/unathi_space
	...
	to the Moghes Hegemony and Sol businesses alike. As moghes is a center for mostunathi religion, however, many spacers feel weak attachments to their oldculture. \
	The stars have been open to unathi for nearly a century now, and some even grew up in space."
	secondary_langs = list(
...
/decl/cultural_info/culture/unathi_yeosa_abyss
	...
	waters during certain hours, and sunbathing during others. They're extremely religious, worshipping sea megafauna as they do their ancestors, and they tend to believe in many a superstition, performing \
