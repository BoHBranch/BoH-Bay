/obj/structure/blob/factory
	...
	desc = "A thick spire of tendrils. A section of the blob that creates numerous hostile entities to attack enemies of the blob.  \
...
/obj/structure/blob/factory/Destroy()
	for(var/mob/living/L in spores)
		var/mob/living/simple_animal/hostile/blob/spore/spore = L
