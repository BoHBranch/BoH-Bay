...
/datum/deity_item/boon/burning_touch
	name = "Burning Touch"
	desc = "Sets your minion's hand aflame, allowing them to burn people with an ever-increasing flame." ///bugged. disable until fixed? unsure
	base_cost = 60
...
/datum/deity_item/boon/burning_grip
	name = "Burning Grip"
	desc = "Give your follower the ability to burn an item in someone's hand so badly it causes them to burn." ///bugged to all hell. see above
	base_cost = 50
