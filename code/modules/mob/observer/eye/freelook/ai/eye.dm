...
/mob/observer/eye/freelook/freelook/cameranet
	name = "Inactive Camera Eye"
	name_sufix = "Camera Eye"

/mob/observer/eye/freelook/freelook/cameranet/New()
	..()
	visualnet = cameranet

/mob/observer/eye/freelook/freelook/aiEye
...
/mob/observer/eye/freelook/freelook/freelook/aiEye/set_dir(new_dir)
	. = ..()
	if(. && isAI(owner))
		var/mob/living/silicon/ai/ai = owner
...
/mob/living/silicon/ai/proc/create_eyeobj(var/newloc)
	...
	eyeobj = new /mob/observer/eye/freelook/freelook/freelook/aiEye(newloc)
	eyeobj.possess(src)
