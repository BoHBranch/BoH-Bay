...
/obj/machinery/power/shield_generator/OnTopic(user, href_list, datum/topic_state/state)
	...
	if(href_list["emergency_shutdown"])
		...
		INVOKE_ASYNC(src, .proc/empulse, src, old_energy / 60000000, old_energy / 32000000, 1) // If shields are charged at 450 MJ, the EMP will be 7.5, 14.0625. 90 MJ, 1.5, 2.8125
		old_energy = 0
