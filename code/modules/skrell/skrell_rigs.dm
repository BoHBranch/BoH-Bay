...
/obj/item/clothing/suit/space/rig/ert/skrell
	...
	icon = 'icons/boh/obj/obj_suit_skrell_rig.dmi'
	...
	sprite_sheets = list(
		SPECIES_SKRELL = 'icons/boh/mob/species/skrell/onmob_chest_rig_skrell.dmi'
	)

/obj/item/clothing/head/helmet/space/rig/ert/skrell
	name = "skrellian recon hardsuit helmet"
	icon = 'icons/boh/obj/obj_head_skrell_rig.dmi'
	desc = "A powerful recon hardsuit with integrated power supply and atmosphere. It's impressive design perfectly tailors to the user's body."
	light_overlay = "helmet_light_dual"
	species_restricted = list(SPECIES_SKRELL)
	sprite_sheets = list(
		SPECIES_SKRELL = 'icons/boh/mob/species/skrell/onmob_head_rig_skrell.dmi'
	)

/obj/item/clothing/shoes/magboots/rig/ert/skrell
	name = "skrellian recon hardsuit boots"
	icon = 'icons/boh/obj/obj_feet_skrell_rig.dmi'
	desc = "A powerful recon hardsuit with integrated power supply and atmosphere. It's impressive design perfectly tailors to the user's body."
	species_restricted = list(SPECIES_SKRELL)
	sprite_sheets = list(
		SPECIES_SKRELL = 'icons/boh/mob/species/skrell/onmob_feet_rig_skrell.dmi'
	)
...
/obj/item/weapon/rig/skrell
	...
	desc = "A powerful recon hardsuit with integrated power supply and atmosphere. It's impressive design perfectly tailors to the user's body."
	icon = 'icons/boh/obj/rig_modules.dmi'
