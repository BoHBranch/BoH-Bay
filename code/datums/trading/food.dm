...
/datum/trader/ship/grocery
	...
	speech = list("hail_generic"     = "Hello, welcome to ORIGIN, convenience store of the future!",
...
/datum/trader/ship/bakery
	...
	name_language = TRADER_DEFAULT_NAME
	origin = "Bakery"
	possible_origins = list("Food By Design", "Corner Store Local", "Mama Joes Eatery", "Nutrition and Fun")

	speech = list("hail_generic"     = "Hello, welcome to ORIGIN! We serve Food, and lots of it!",
				...
				"trade_no_goods"     = "Cash for snacks! That's our business!",
				...
				"insult_good"        = "My goods are NOT knockoffs!",
