...
/datum/trader/trading_beacon
	...
	possible_trading_items = list(/obj/item/weapon/storage/bag                       = TRADER_SUBTYPES_ONLY,
								...
								/obj/item/device/flashlight/flashdark                = TRADER_THIS_TYPE,
								/obj/item/weapon/storage/box/anti_photons            = TRADER_THIS_TYPE,
...
/datum/trader/trading_beacon/manufacturing
	...
	possible_trading_items = list(/obj/structure/AIcore             = TRADER_THIS_TYPE,
								...
								/obj/structure/casino               = TRADER_SUBTYPES_ONLY,
								/obj/structure/casino/roulette_chart = TRADER_BLACKLIST,
								/obj/structure/casino/bj_table      = TRADER_BLACKLIST,
								/obj/structure/casino/bj_table/bj_right = TRADER_BLACKLIST,
