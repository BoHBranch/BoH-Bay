/datum/game_mode/revolution
	...
	extended_round_description = "Time in space, away from home and loved ones, takes its toll on even the most grizzled space travelers. As time goes on, some crew find themselves \
								...
								As their peers find themselves surrounded by ever-angrier forces, the situation on the Dagon is rapidly reaching its brutal climax."
	config_tag = "mutiny"
	required_enemies = 4
	required_players = 10
...
/datum/antagonist/revolutionary
	...
	welcome_text = "You've been out here for what feels like an eternity. The time spent in space has worn away at your conscience, and \
					you won't let yourself be canned up like a sardine for even one more jump. Take control of your situation and use the Dagon for your own ends, or \
...
/datum/antagonist/loyalists/Initialize()
	..()
	welcome_text = "The SGV Dagon has been on this mission for some time, and there is still much to accomplish. \
