/obj/overmap/visitable/ship/torch
	name = "SGV Dagon"
	desc = "A bluespace-capable Epsilon-class corvette, broadcasting SG Fleet codes and the designation \"SGV Dagon, 15-D16-SGF-G40\"."
	fore_dir = WEST
	vessel_mass = 100000
...
/obj/overmap/visitable/ship/landable/exploration_shuttle
	name = "Charon"
	desc = "An SSE-U11 long range shuttle, broadcasting SCGEC codes and the callsign \"Dagon-2 Charon\"."
	shuttle = "Charon"
...
/obj/overmap/visitable/ship/landable/aquila
	name = "Aquila"
	desc = "A PM-24 modular transport, broadcasting SCGEC codes and the callsign \"Dagon-1 Aquila\"."
	shuttle = "Aquila"
	vessel_mass = 10000
...
/obj/overmap/visitable/ship/landable/guppy
	name = "Guppy"
	desc = "An SSE-U3 utility pod, broadcasting SCGEC codes and the callsign \"Dagon-3 Guppy\"."
	shuttle = "Guppy"
