...
/obj/item/clothing/suit/armor/pcarrier/grey
	...
	icon = 'maps/torch/icons/boh/obj/clothing/obj_modular_armor.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/boh/mob/onmob/onmob_modular_armor.dmi')
...
/obj/item/clothing/accessory/armguards/light/grey
	...
	icon_override = 'maps/torch/icons/boh/mob/onmob/onmob_modular_armor.dmi'
	accessory_icons = list(slot_tie_str = 'maps/torch/icons/boh/mob/onmob/onmob_modular_armor.dmi', slot_wear_suit_str = 'maps/torch/icons/boh/mob/onmob/onmob_modular_armor.dmi')
