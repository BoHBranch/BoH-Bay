/obj/item/clothing/accessory/cloak
	...
	icon = 'maps/torch/icons/obj/obj_cloak.dmi'
	icon_state = "cloak"
	icon_override = 'maps/torch/icons/mob/onmob_cloak.dmi'
	accessory_icons = list(slot_tie_str = 'maps/torch/icons/mob/onmob_cloak.dmi', slot_w_uniform_str = 'maps/torch/icons/mob/onmob_cloak.dmi', slot_wear_suit_str = 'maps/torch/icons/mob/onmob_cloak.dmi')
...
/obj/item/clothing/suit/storage/toggle/labcoat/lclabcoat
	icon = 'maps/torch/icons/boh/obj/clothing/longlabcoats.dmi'
	name = "long labcoat"
