/obj/item/clothing/mask/breath/gill
	name = "\improper Skrellian gill cover"
	...
	icon = 'maps/torch/icons/boh/obj/clothing/obj_mask.dmi'
	icon_override = 'maps/torch/icons/boh/mob/onmob/onmob_mask.dmi'
