...
/obj/item/weapon/gun/launcher/rocket/recoilless/sec
	name = "TVP-3"
	desc = "A much more odd version of what the original was. This incorporates a hefty locking system, increasing the weight, though ensuring safety aboard a vessel."
	req_access = list(access_infantry)
