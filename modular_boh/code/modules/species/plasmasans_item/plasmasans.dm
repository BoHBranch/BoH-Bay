...
/obj/item/clothing/suit/space/plasmasans
	...
	icon = 'modular_boh/icon/obj/plasmasans/obj_suit_plasmasans.dmi'
	...
	sprite_sheets = list(
		SPECIES_PLASMASANS = 'modular_boh/icon/obj/plasmasans/onmob_suit_plasmasans.dmi'
		)
	can_breach = 1
...
/obj/item/clothing/head/helmet/space/plasmasans
	...
	icon = 'modular_boh/icon/obj/plasmasans/obj_head_plasmasans.dmi'
	...
	sprite_sheets = list(
		SPECIES_PLASMASANS = 'modular_boh/icon/obj/plasmasans/onmob_head_plasmasans.dmi'
		)
	armor = list(
		melee = ARMOR_MELEE_KNIVES,
		bullet = ARMOR_BALLISTIC_MINOR,
