...
/obj/machinery/computer/cloning/proc/scan_mob(mob/living/carbon/subject as mob)
	if (!subject.dna)
	...
	if(istype(subject, /mob/living/carbon/brain))	//#VESTA.BAY# Checks if the flavor/descriptors will come from brain or body
		var/mob/living/carbon/brain/brain = subject
		R.body_descriptors = brain.descriptors
		R.flavor = brain.flavor_texts
	else if (istype(subject, /mob/living/carbon/human))
		var/mob/living/carbon/human/player = subject
